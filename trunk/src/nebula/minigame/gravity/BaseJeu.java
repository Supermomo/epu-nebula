	...
	public void update(GameContainer container, int delta) throws SlickException {
		...
		if (container.getInput().isKeyDown(Input.KEY_LEFT)) {
			if(!map.deplacementBloquant(
					((Float) (hero.getX()-1*deplacement)).intValue(),
		...
		if (container.getInput().isKeyDown(Input.KEY_RIGHT)) {
			if(!map.deplacementBloquant(
					((Float) (hero.getX()+1*deplacement+hero.getImage().getWidth())).intValue(),
					((Float) (hero.getY()+1)).intValue() ))
			{
				hero.moveX(+1*deplacement);
		...
		if (container.getInput().isKeyDown(Input.KEY_UP)) {
			if(!map.deplacementBloquant(
					((Float) (hero.getX()+hero.getImage().getWidth()/2)).intValue(),
					((Float) (hero.getY()-1*deplacement)).intValue() ))
		...
		if (container.getInput().isKeyDown(Input.KEY_DOWN)) {
			if(!map.deplacementBloquant(
					((Float) (hero.getX()+hero.getImage().getWidth()/2)).intValue(),
					((Float) (hero.getY()+1*deplacement+hero.getImage().getHeight())).intValue() ))
				hero.moveY(+1*deplacement);
		}
		else {
